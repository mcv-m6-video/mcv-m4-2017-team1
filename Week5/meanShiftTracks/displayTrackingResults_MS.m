function [speed_limit_pictures,speed_limit_id,speed_limit_labels]=displayTrackingResults_MS(frame,mask,tracks,velocity,speed_limit_pictures,speed_limit_id,speed_limit_labels)
