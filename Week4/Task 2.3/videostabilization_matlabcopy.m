...
videoWriter = vision.VideoFileWriter('trafficStabilized.avi','FrameRate',...
    30);
%%
...
pos.template_orig = [50 140]; % [x y] upper left corner
pos.template_size = [50 60];   % [width height]
...
while ~isDone(hVideoSource)
    ...
    step(videoWriter, [input(:,:,1) Stabilized]);
end
