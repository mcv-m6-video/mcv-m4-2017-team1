...
figure();
    plot(vec(1,:,2),vec(1,:,1))
    hold on
    plot(vec_new(1,:,2),vec_new(1,:,1))
    hold off
title('Highway P-R curve'); xlabel('Recall'); ylabel('Precision')
legend('Baseline','Imfill + Opening'); axis([0 1 0 1])
...
figure();
    plot(vec(3,:,2),vec(3,:,1))
    hold on
    plot(vec_new(3,:,2),vec_new(3,:,1))
    hold off
title('Fall P-R curve'); xlabel('Recall'); ylabel('Precision')
legend('Baseline','Imfill + Opening'); axis([0 1 0 1])
