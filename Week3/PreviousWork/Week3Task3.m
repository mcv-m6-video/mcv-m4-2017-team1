...
%SE = strel('diamond',R); %R=distance from the SE to the points of the diamond
%SE = strel('line',len,deg);  %len es llargada i deg els graus 
%SE = strel('sphere',R) ; %R es radius
